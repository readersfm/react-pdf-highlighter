      ...
      {isDualPageArrow && (
        <>
          ...
          >
            ...
            >
              <path
                d="M90.9423 56.4943L44.0653 17.4301C42.4718 16.1119 40.4208 15.479 38.3615 15.6698C36.3022 15.8607 34.4025 16.8598 33.0783 18.4484C31.7541 20.037 31.1135 22.0856 31.2965 24.1456C31.4796 26.2056 32.4716 28.1091 34.0552 29.4392L73.7297 62.4991L34.0552 95.559C32.4655 96.8873 31.4681 98.7923 31.282 100.856C31.0959 102.919 31.7364 104.971 33.0628 106.563C34.3892 108.154 36.293 109.154 38.356 109.342C40.419 109.531 42.4725 108.893 44.0653 107.568L90.9423 68.5034C91.8213 67.769 92.5283 66.8507 93.0135 65.8131C93.4986 64.7756 93.7501 63.6442 93.7501 62.4988C93.7501 61.3535 93.4986 60.2221 93.0135 59.1845C92.5283 58.147 91.8213 57.2286 90.9423 56.4943Z"
                fill="#333"
              />
            </svg>
          </div>
...
const HighlightPopup = ({ comment, onDeleteClick, onEditClick }: any) =>
  comment.text ? (
    <div className="Highlight__popup">
      <div>{comment.text}</div>{" "}
      <div className="Highlight__popup__dialog__wrapper">
        <div className="Highlight__popup__dialog">
          ...
          <div className="" onClick={() => onEditClick()}>
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
